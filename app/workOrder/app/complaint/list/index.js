...
import {getComplaintList, getShopList, getNodeStatus, getComplaintSource, getCustomerType, getUpgradeStatus} from "../api";
		...
		return (
			<Fragment>
              ...
              筛选
					...
					<List data={this.state.complaintList.map.all} fields={fields} clickCallback={(id)=>window.location.href = './complaintDetail?id='+id}/>
